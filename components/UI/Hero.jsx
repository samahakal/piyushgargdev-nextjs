            ...
            <div className="mt-5 flex place-content-center md:block">
              <div className="relative inline-flex group">
                ...
                <Link
                  ...
                  className="relative text-sm sm:text-md md:text-lg text-center items-center justify-center px-8 py-4  font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30"
                  role="button"
                >
                  <span
                    style={{
            ...
            <div className="mt-5 flex flex-col items-center justify-center">
              <div className="relative inline-flex group">
                ...
                <Link
                  target="_blank"
                  href="https://discord.gg/kRSRxBQ6xf"
                  className="relative w-full text-sm sm:text-md md:text-lg text-center items-center justify-center px-8 py-4  font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30"
                  role="button"
                >
                  <span
                    style={{
